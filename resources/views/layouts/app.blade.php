...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper" style="background-image: url('storage/images/bg-side.jpg');">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="{{ url('/home') }}">{{ config('app.name') }}</a>.</strong> All rights
        reserved.
    </footer>
</div>
